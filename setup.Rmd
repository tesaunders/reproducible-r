...
- Selecting Tools > Install Packages > and entering `readr, dplyr, tidyr, ggplot2, purrr, renv, car, rstatix` and select 'Install'.
...
```{r, eval=FALSE}
install.packages(c("readr", "dplyr", "tidyr", "ggplot2", "purrr", "renv", "car", "rstatix"))
```
