...
- Selecting Tools > Install Packages > and entering `readr, dplyr, tidyr, ggplot2, purrr, renv, car` and select 'Install'.
...
```{r, eval=FALSE}
install.packages(c("readr", "dplyr", "tidyr", "ggplot2", "purrr", "renv", "car"))
```
